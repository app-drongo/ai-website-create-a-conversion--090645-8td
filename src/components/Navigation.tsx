...
import { Menu, X, Calendar, Pill } from "lucide-react"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-3">
              <div className="size-10 rounded-lg bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                <Pill className="size-5 text-background" />
              </div>
              <div className="flex flex-col">
                <span className="font-bold text-xl text-foreground">WellnessHub</span>
                <span className="text-xs text-muted-foreground -mt-1">Pharmacy</span>
              </div>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button size="sm" className="bg-primary hover:bg-primary/90 text-background group">
